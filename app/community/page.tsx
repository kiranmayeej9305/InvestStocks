...
export default function CommunityPage() {
  const { user } = useAuth()
  const { enabled: communityEnabled, loading } = useFeatureFlag('community', user?.plan || 'free')
  ...
  if (!communityEnabled) {
    return (
      <FeatureGuard
        ...
        isAllowed={false}
        upgradeMessage="Community features including investment discussions and social trading are available in Pro and Enterprise plans"
