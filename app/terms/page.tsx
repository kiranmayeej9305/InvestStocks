      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <Card className="glass-morphism-light border-primary/20">
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Welcome to InvestSentry! These Terms of Service (&quot;Terms&quot;, &quot;Terms of Service&quot;) govern your 
              use of our web application located at InvestSentry.com (together or individually &quot;Service&quot;) 
              operated by InvestSentry.
            </p>
            <p>
        ...
        <Card className="glass-morphism-light border-primary/20">
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
            <div>
              ...
              <p>
                InvestSentry offers both free and paid subscription plans. Details of each plan, including 
        ...
        <Card className="glass-morphism-light border-primary/20 border-2">
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
            <div className="p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  <strong>Not Financial Advice:</strong> InvestSentry provides information and tools for 
            ...
            <p className="pt-2">
              By using InvestSentry, you acknowledge that you understand these risks and agree that we are not 
        ...
        <Card className="glass-morphism-light border-primary/20">
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              ...
              features, and functionality are and will remain the exclusive property of InvestSentry and its 
              licensors.
            </p>
            <p>
              Our trademarks and trade dress may not be used in connection with any product or service without 
              the prior written consent of InvestSentry.
            </p>
            <div>
        ...
        <Card className="glass-morphism-light border-primary/20">
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              To the maximum extent permitted by applicable law, InvestSentry and its affiliates, officers, 
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <div className="space-y-2 pt-2">
              <p>
                ...
                <a href="mailto:legal@InvestSentry.com" className="text-primary hover:underline">
                  legal@InvestSentry.com
                </a>
              </p>
              <p>
